...
lcc -Wa-l -Wl-m -Wf--debug -Wl-y -Wl-w -Wm-yn 2048 -o ./2048.gb ./build/main.o ./build/board.o ./build/font.o ./build/screens.o ./build/utils.o ./build/block_tiles.o ./build/number_tiles.o ./build/logo_data.o ./build/logo_map.o ./build/trophy_data.o ./build/trophy_map.o